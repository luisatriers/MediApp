...
router.get('/doctors', async (req, res) => {
    try {
        ...
        res
            .status(500)
            .send('Error while getting doctors');
    }
});
...
router.get('/getDoctor/:id', async (req, res) => {
    ...
    try {
        ...
        res
            .status(500)
            .send('Error while getting Doctor');
    }
});
...
router.post('/postDoctor', async (req, res) => {
    ...
    try {
        ...
        res
            .status(500)
            .send('Error while saving doctor' + error);
    }
});
...
router.put('/doctors/:id', async (req, res) => {
    ...
    try {
        ...
        res
            .status(500)
            .send('Error while updating doctor');
    }
});
...
router.delete('/doctors/:id', async (req, res) => {
    ...
    try {
        ...
        res
            .status(500)
            .send('Error while deleting doctor');
    }
});
